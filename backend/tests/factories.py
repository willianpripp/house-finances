...
PARTNER_GROSS = Decimal("2500.00")
PARTNER_GROSS_AFTER_RAISE = Decimal("2750.00")  # exercises the salary_levels lookup
PRIMARY_GROSS_FOREIGN = Decimal("11500.00")
FED_WITHHOLDING = Decimal("251.31")
STATE_WITHHOLDING = Decimal("75.11")
ACCOUNTANT_FEE = Decimal("195.00")      # INDEFINITE Taxes fee — must roll
FOREIGN_TAX_PAYMENT = Decimal("690.00")  # variable tax payment — must NOT roll
CAR_INSTALLMENT = Decimal("379.82")
STREAMING = Decimal("15.99")
